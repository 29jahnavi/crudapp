                        ...
                        <form method="post" id="login">
                            ...
                            <div class="ad-auth-form">
                                <div class="ad-auth-feilds mb-30">
                                    <input type="text" name="email" placeholder="Email Address" class="ad-input" />
                            ...
                            <div class="ad-other-feilds">
                                ...
                                <a class="forgot-pws-btn" href="{{url('/send-link')}}">Forgot Password?</a>
                            </div>
                            ...
                            <p class="ad-register-text">Don't have an account? <a href="{{url('/register')}}">Click Here</a></p>
                        </form>
                    </div>
                </div>
            </div>
