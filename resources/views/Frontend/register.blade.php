...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="ad-auth-img">
                        <img src="{{url('assets/images/auth-img1.png')}}" alt="" />
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        ...
                        <form id="form">
                            ...
                            <div class="ad-auth-form">
								<div class="ad-auth-feilds mb-30">
                                    <input type="text" name="name" placeholder="Enter Name" class="ad-input" />
                                ...
                                <div class="ad-auth-feilds mb-30">
                                    <input type="text" name="email" id="email" placeholder="Email Address" class="ad-input" />
                                    <div class="ad-auth-icon">
                            ...
                            <div class="ad-auth-btn">
                                <button  class="ad-btn ad-login-member" name="submit" type="submit">Sign up</button>
                            </div>
                            <div class="form-group mb-0">
                                <p id="message"></p>
                            </div>
                            <p class="ad-register-text">Already have an account ? <a href="{{url('/login')}}">Login</a></p>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="{{url('assets/js/registration.js')}}"></script>
</body>
<!-- Mirrored from kamleshyadav.com/html/splashdash/splashdash-admin-template/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Aug 2021 12:33:54 GMT -->
</html>