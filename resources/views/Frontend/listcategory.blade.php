@include ('finallayout.view')
    <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-pill mt-2" role="group" aria-label="Basic example">
                                            <a class="btn btn-primary sm-btn" href={{"editcat/".Crypt::encrypt($item['id'])}}>Edit</a>
                                            <a class="btn btn-danger sm-btn" href="{{url('delete-cat/' .$item['id'])}}">Trash</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
        ...
        <a class="btn btn-danger sm-btn" href="{{url('/category/trash')}}">Go To Trash</a>
    </div>
